...
MRS_struct.version.load = '200302'; % set to date when final updates have been made
MRS_struct.ii = 0;
...
if ii == length(metabfile) && MRS_struct.p.mat
    save(fullfile(pwd,'CoRegStandAlone_output','MRS_struct_CoRegStandAlone.mat'),'MRS_struct');
end
